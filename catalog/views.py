...
class BookReservations(LoginRequiredMixin, View):
    def get(self, request, id):
        ...
        for i in book_instance_reservation:
            if i.status != 'a':
                ...
                return render(request, 'catalog/book_reservation.html',
                              {'book_instance_reservation': book_instance_reservation})
...
class UserBookHistoryView(LoginRequiredMixin, View):
    def get(self, request):
